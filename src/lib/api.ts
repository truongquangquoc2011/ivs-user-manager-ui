...
export const userApi = {
  getAll: () => apiFetch<UserResponse[]>('/api/v1/users'),
...
export const groupApi = {
  ...
  addUser: (groupId: number, userId: number) =>
    apiFetch<null>(`/api/v1/groups/${groupId}/users/${userId}`, { method: 'POST' }),
  removeUser: (groupId: number, userId: number) =>
    apiFetch<null>(`/api/v1/groups/${groupId}/users/${userId}`, { method: 'DELETE' }),
